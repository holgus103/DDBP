...
# pretrain each layer
a.pretrain(0.01, 0, 7000, data_batches, 0, 0.01, "./summaries/colors_4/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2, 5);
a.pretrain(0.005, 1, 8500, data_batches, 0, 0.01, "./summaries/colors_4/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2, 5);
a.pretrain(0.001, 2, 10000, data_batches, 0, 0.01, "./summaries/colors_4/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2, 5);
a.pretrain(0.001, 3, 12500, data_batches, 0, 0.01, "./summaries/colors_4/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2, 5);

# create classifier
c = models.Classifier(a, 14);

# train whole network
c.train(data_batches, outputs_batches, 0.001, 15000, 0.0001, "./summaries/colors_4/finetuning");

# evaluate results
print(c.test(data, outputs));
print(c.test(test_data, test_outputs));
print(c.suit_based_accurancy(data, outputs, 1));
print(c.suit_based_accurancy(test_data, test_outputs[test_end:l], 5));
