...
# train whole network
c.train(data_batches, outputs_batches, 0.0001, 15000, 0.0001, path +"/finetuning", data, outputs, test_data, test_outputs, 1, 1, models.Model.mse_loss, 25, experiment_name);
