...
# import data
data, outputs = dp.read_file("./../data/sol100000.txt", 25000, True, False, True);
...
# pretrain each layer
a.pretrain(0.01, 0, 5000, data_batches, 0, "./summaries/colors_3/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2);
a.pretrain(0.005, 1, 7500, data_batches, 0, "./summaries/colors_3/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2);
a.pretrain(0.001, 2, 10000, data_batches, 0, "./summaries/colors_3/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2);
a.pretrain(0.001, 3, 12500, data_batches, 0, "./summaries/colors_3/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2);

# create classifier
c = models.Classifier(a, 14);

# train whole network
c.train(data_batches, outputs_batches, 0.001, 15000, "./summaries/colors_3/finetuning");
