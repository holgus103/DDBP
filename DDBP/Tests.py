...
def one_layer_cross_entropy_rms_opttest() :
    ...
    a.pretrain(learningRate, 0, 0, data, 0.0001, "./summaries/one_layer_smalldataset_rms_crsent_{0}".format(learningRate) + "{0}", tf.train.RMSPropOptimizer);
...
def one_layer_many_pretrains() :
    ...
    learningRate = 0.05;
    a = Autoencoder.Autoencoder(217, [104], Autoencoder.Autoencoder.crossEntropyLoss);
    a.pretrain(learningRate, 0, 0, data, 1.0, "./summaries/one_layer_many_pretrains-part1{0}".format(learningRate) + "{0}", tf.train.RMSPropOptimizer);
    learningRate = 0.01;
    a.pretrain(learningRate, 0, 0, data, 0.0001, "./summaries/one_layer_many_pretrains-part2{0}".format(learningRate) + "{0}", tf.train.RMSPropOptimizer);

def one_layer_rms_rms_opttest() :
    data, outputs = DataParser.ReadFile("sol100000.txt", 50);
    learningRate = 0.05;
    a = Autoencoder.Autoencoder(217, [104], Autoencoder.Autoencoder.mseLoss);
    a.pretrain(learningRate, 0, 0, data, 0, "./summaries/one_layer_smalldataset_rms_rms_{0}".format(learningRate) + "{0}", tf.train.RMSPropOptimizer);

def one_layer_direct_rms_opttest() :
    data, outputs = DataParser.ReadFile("sol100000.txt", 50);
    learningRate = 0.05;
    a = Autoencoder.Autoencoder(217, [104], Autoencoder.Autoencoder.directError);
    a.pretrain(learningRate, 0, 0, data, 0, "./summaries/one_layer_smalldataset_direct_rms_{0}".format(learningRate) + "{0}", tf.train.RMSPropOptimizer);
...
def one_layer_cross_entropy_gradient_descent_test() :
    ...
    learningRate = 0.01;
    a = Autoencoder.Autoencoder(217, [104], Autoencoder.Autoencoder.crossEntropyLoss);
    a.pretrain(learningRate, 0, 0, data, 1.0, "./summaries/one_layer_smalldataset_gradient_crsent{0}".format(learningRate) + "{0}", tf.train.GradientDescentOptimizer);

def one_layer_cross_entropy_adam_opt_test() :
    data, outputs = DataParser.ReadFile("sol100000.txt", 50);
    learningRate = 0.01;
    a = Autoencoder.Autoencoder(217, [104], Autoencoder.Autoencoder.crossEntropyLoss);
    a.pretrain(learningRate, 0, 0, data, 1.0, "./summaries/one_layer_smalldataset_adam_crsent{0}".format(learningRate) + "{0}", tf.train.AdamOptimizer);
...
def one_layer_rms_error_test() :
    ...
    learningRate = 0.01;
    a = Autoencoder.Autoencoder(217, [104], Autoencoder.Autoencoder.mseLoss);
    a.pretrain(learningRate, 0,  0, data, 1.0, "./summaries/one_layer_smalldataset_rms_rmserror{0}".format(learningRate) + "{0}", tf.train.RMSPropOptimizer, 0.2);
...
def full_cross_entropy_test() :
    ...
    a.pretrain(0.01, 0, 5000, data, 0.0001, path, tf.train.RMSPropOptimizer, 0.2);
    a.pretrain(0.01, 1, 3000, data, 0.01, path, tf.train.RMSPropOptimizer, 0.2);
    a.pretrain(0.01, 2, 4000, data, 5, path , tf.train.RMSPropOptimizer, 0.2);
    a.pretrain(0.01, 3, 4000, data, 10, path , tf.train.RMSPropOptimizer, 0.2);

def save_test():
    data, outputs = DataParser.ReadFile("sol100000.txt", 50);
    learningRate = 0.05;
    a = Autoencoder.Autoencoder(217, [104], Autoencoder.Autoencoder.crossEntropyLoss);
    a.pretrain(learningRate, 0, 0, data, 0.0001, "./summaries/save_test{0}".format(learningRate) + "{0}", tf.train.RMSPropOptimizer, 0.2);
...
def smalldataset_goodresults():
    ...
    a = Autoencoder.Autoencoder(217, [104, 52, 26, 13], Autoencoder.Autoencoder.crossEntropyLoss);
    a.pretrain(0.01, 0, 5000, data[0:1001], 0, "./summaries/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2);
    a.pretrain(0.01, 1, 3000, data[0:1001], 0, "./summaries/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2);
    a.pretrain(0.01, 2, 4000, data[0:1001], 0, "./summaries/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2);
    a.pretrain(0.01, 3, 4000, data[0:1001], 0, "./summaries/pretrain{0}" , tf.train.RMSPropOptimizer, 0.2);
...
def variousL1Sizes():
    ...
    data, outputs = DataParser.ReadFile("sol100000.txt", 10000);
    #l = len(data);
    ...
    for i in sizes:
        a = Autoencoder.Autoencoder(217, [i], Autoencoder.Autoencoder.crossEntropyLoss);
        a.pretrain(0.01, 0, 10000, data, 0, "./summaries/oneLayer{0}".format(i) + "{0}" , tf.train.RMSPropOptimizer, 0.2);
